...
COMMAND_CONTRACTS = (
    ...
    CommandContract(
        ...
        registry_markers=("/marcus.verify", "run_harness_postflight.py", "validate_doc_sync.py", "validate_docs_substance.py"),
    ),
    CommandContract(
    ...
    CommandContract(
        ...
        registry_markers=("/develop", "build_context_index.py", "validate_context_index.py", "create_development_docs.py", "validate_doc_sync.py", "validate_docs_substance.py"),
    ),
    CommandContract(
        command="/quick_fix",
        ...
        registry_markers=("/quick_fix", "build_context_index.py", "validate_context_index.py", "run_harness_preflight.py", "create_doc_sync_note.py", "validate_docs_substance.py"),
    ),
    CommandContract(
        command="/planning",
        ...
        usage_markers=("/planning", "validate_planning_research.py --root . --strict-outputs", "validate_docs_substance.py --root . --strict-planning"),
        readme_markers=("/planning", "validate_planning_research.py", "validate_docs_substance.py"),
        registry_markers=("/planning", "create_feature_spec.py", "validate_planning_research.py", "validate_docs_substance.py"),
    ),
    CommandContract(
        ...
        usage_markers=("/doc_reconcile", "audit_development_docs.py --root .", "validate_docs_substance.py"),
        readme_markers=("/doc_reconcile", "audit_development_docs.py --root .", "validate_docs_substance.py"),
        registry_markers=("/doc_reconcile", "audit_development_docs.py", "validate_doc_sync.py", "validate_docs_substance.py"),
    ),
    CommandContract(
        command="/bootstrap",
