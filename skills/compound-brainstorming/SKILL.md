...
- **The Circuit Breaker Rule (Loop Execution):** If your brainstorming routine loops into un-achievable physical states 3 times (e.g., requesting infinite hardware RAM capabilities to solve a problem), YOU MUST HALT. Force the User to accept a compromise logic structure. Throw a Terminal Alert 🚩.
