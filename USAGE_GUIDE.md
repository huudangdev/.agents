...
| `/auto_software_factory` | Launching heavy Fullstack feature branches requiring System Design (FSD, DDD), Database Schema migrations, and Frontend integration. | Orchestrates the full 9-Phase pipeline, sequentially aligning DB models, API contracts, and Backend TDD before constructing the UI. |
